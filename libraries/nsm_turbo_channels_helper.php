 ...
 * $this->EE->nsm_turbo_channels_helper->addCSS('custom_field.css');
 * 
 * # Load the JS for the iframe
 * $this->EE->nsm_turbo_channels_helper->addJS('custom_field.js');
 ...
 */
class Nsm_turbo_channels_helper {
